...
public class FilterDispatcher implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (url.equals("admin.jsp") || url.equals("member.jsp")) {
                if (!dto.getRole().equals("member") && !dto.getRole().equals("admin")) {
                    url = "login.jsp";
                }
            }
            
            if (url.equals("member.jsp")) {
            ...
            if (resource.endsWith("png") || resource.endsWith("js")||resource.endsWith("css") || resource.endsWith("jpg")) {
